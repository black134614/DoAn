<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="QuanLyGiaoDien.aspx.vb" Inherits="admin_QuanLyTinBai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    ...
    <section id="home-shortcut">
        <div class="row">
            ...
            <div class="col-6 col col-md-3 my-3">
                <a href="HinhAnhHoatDongEdit.aspx">
                    <div class="card h-100 p-3 text-center">
                        <span class="fa fa-plus fa-5x"></span>
                        <div>Thêm ảnh hoạt động</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col col-md-3 my-3">
