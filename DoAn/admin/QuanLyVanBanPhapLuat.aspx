<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="QuanLyVanBanPhapLuat.aspx.vb" Inherits="admin_QuanLyTinBai" %>
            ...
            <div class="col-6 col col-md-3 my-3">
                <a href="VanBanPhapLuatEdit.aspx">
                    <div class="card h-100 p-3 text-center">
                        ...
                        <div>Đăng Văn Bản Pháp Luật Mới</div>
                    </div>
                </a>
            </div>
        </div>
